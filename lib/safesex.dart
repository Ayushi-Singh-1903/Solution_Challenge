...
class safesex extends StatefulWidget {
  const safesex({Key? key}) : super(key: key);

  @override
  State<safesex> createState() => _safesexState();
}

class _safesexState extends State<safesex> {
  final CollectionReference _myths =
  FirebaseFirestore.instance.collection('SafeSex');
                    ...
                    child:  Row(
                      children: [
                        Align(
                          ...
                          child: Hero(
                            tag: 1,
                            child: Image.asset("images/safesex.png"),
                          ),
                        ),
                        Align(
                          alignment: Alignment.centerRight,
                          child: Text('SAFE SEX', style: TextStyle(
                            color: Colors.black,
                            fontSize: 30,
