...
class myths3 extends StatefulWidget {
  const myths3({Key? key}) : super(key: key);

  @override
  State<myths3> createState() => _myths3State();
}

class _myths3State extends State<myths3> {
  final CollectionReference _myths =
  FirebaseFirestore.instance.collection('MythsL');
  @override
                    ...
                    child:  Row(
                      children: [
                        Align(
                          ...
                          child: Hero(
                            tag: 1,
                            child: Image.asset("images/lesbian.png"),
                          ),
                        ),
                        Align(
