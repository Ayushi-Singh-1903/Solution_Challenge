...
class myths2 extends StatefulWidget {
  const myths2({Key? key}) : super(key: key);

  @override
  State<myths2> createState() => _myths2State();
}

class _myths2State extends State<myths2> {
  final CollectionReference _myths =
  FirebaseFirestore.instance.collection('MythsG');
  @override
                    ...
                    child:  Row(
                      children: [
                        Align(
                          ...
                          child: Hero(
                            tag: 1,
                            child: Image.asset("images/gay.png"),
                          ),
                        ),
                        Align(
